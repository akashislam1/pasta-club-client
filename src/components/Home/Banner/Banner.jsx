  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 my-12 gap-4">
      <div className="md:p-20">
        ...
        <div className="p-3">
          <button
            className="font-semibold text-white bg-[#F65900] text-center  rounded  hover:bg-white hover:text-[#F17228] border hover:border-[#F65900] duration-200 py-2 px-8  focus:outline-none focus:shadow-outline"
            type="submit"
          >
