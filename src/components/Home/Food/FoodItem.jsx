  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
      <div className=" my-relative-class ">
        <img className="h-full " src={chickenImg} alt="" />
        <h3 className="my-absolute-class">Italian Chicken Curry</h3>
      </div>
      <div className=" my-relative-class ">
        <img className="h-full hover:opacity-0" src={noodlesImg} alt="" />
        <h3 className="my-absolute-class">Italian Noodles</h3>
      </div>
      <div className=" my-relative-class ">
        <img className="h-full hover:opacity-50" src={pastaImg} alt="" />
        <h3 className="my-absolute-class">Italian Spaghetti Pasta</h3>
      </div>
      <div className=" my-relative-class ">
        <img className="h-full hover:opacity-50" src={pizzaImg} alt="" />
