      ...
      <div className="w-full md:w-5/6 mx-auto">
        <div className="mt-1 ml-auto w-36">
          <Pdf targetRef={blogRef} filename="blogs.pdf">
            {({ toPdf }) => (
              <button className="border py-1 px-3 ml-auto" onClick={toPdf}>
                Generate Pdf
              </button>
            )}
          </Pdf>
          ...
          <div>
            ...
            <div className="p-4">
              ...
              <div className="flex flex-col gap-4 my-4">
                <p>
                  1. Install the
                  <span className="font-bold">&quot;prop-types&quot;</span>{" "}
                  package if it&apos;s not already installed. You can install it
                  using npm or yarn.
                </p>
                <p>
                  2. Import the
                  <span className="font-bold">&quot;PropTypes&quot;</span>{" "}
                  library from the
                  <span className="font-bold">&quot;prop-types&quot;</span>{" "}
                  package at the top of your component file.
                </p>
                <p>
                  3. Define the PropTypes for your component by adding a
                  <span className="font-bold">&quot;propTypes&quot;</span>{" "}
                  object as a property of the component&apos;s class.
                </p>
                <p>
                  4. Inside the
                  <span className="font-bold">&quot;propTypes&quot;</span>{" "}
                  object, specify the data types and requirements for each prop
                  using the appropriate PropTypes validator. For example, you
                  can use
                ...
                <p>
                  5. Once you have defined the PropTypes for your component,
                  React will automatically check the props passed to your
                  component against the PropTypes you have defined. If any prop
                  doesn&apos;t match the specified type or is missing a required
                  prop, React will log a warning in the console.
                </p>
              </div>
              <p>
                Using PropTypes to validate props is important because it helps
                you catch errors early on and ensures that your components are
                used correctly. By defining PropTypes, you can make your
                components more robust and easier to maintain over time.
              </p>
            </div>
          </div>
          <div className="my-4">
            ...
            <div className="p-4">
              <p className="mb-5">
                ...
                language. Most of the people are confused and understand
                it&apos;s a framework or a programming language. We often use
                Node.js for building back-end services like APIs like Web App or
                Mobile App. It&apos;s used in production by large companies such
          ...
          <div className="mb-4">
            ...
            <div className="p-4">
              <p>
                ...
                function which we create by ourselves, when we want to share
                logic between other JavaScript functions. It allows you to reuse
                some piece of code in several parts of your app.
              </p>
              <p className="mt-3">
